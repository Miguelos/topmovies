...
public class MovieListActivity extends FragmentActivity implements
    ...
    public void onItemSelected(String summary, String poster) {
        if (mTwoPane) {
            ...
            arguments.putString(MovieDetailFragment.ARG_MOVIE_SUMMARY, summary);
            arguments.putString(MovieDetailFragment.ARG_MOVIE_POSTER, poster);
            ...
            detailIntent.putExtra(MovieDetailFragment.ARG_MOVIE_SUMMARY,
                    summary);
            detailIntent.putExtra(MovieDetailFragment.ARG_MOVIE_POSTER, poster);
